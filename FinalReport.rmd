...
The grid analysis I am choosing is Cat~cat because we are analysizing .. The subsetting should be change to drug users, we have to subset the data to include only druggies. 
