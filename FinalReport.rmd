...
Chi Square test: The p-value is 1.4242e-07 therefore disproving the null hypothesis  and proving the relationship between the vaccine and decreasing the likihood of contracting the virus.

Fisher"s Exact:  Fisher test demonstrates that the odds ration estimated to 0.35%

# Discussion and Conclusion

<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->

By analyzing the data and something the Chi Squared test to get the p-value, the null hypothesis must be rejected, proving the vaccine does prevent the contraction of AIDS in drug users. The data shows a .35% higher likelihood of contracting AIDS in the drug users who received the placebo than the drug users who received the vaccination.  